...
llm = LLM(model="gpt2-large", tensor_parallel_size=4)
...
# np.save("gpt2_triviaqa_test_answers_all5.npy", outputs_all)
np.save("gpt2_triviaqa_train_answers_all30.npy", outputs_all)
answer_types_all = np.array(answer_types_all)
# np.save("gpt2_triviaqa_test_answer_types_all5.npy", answer_types_all)
np.save("gpt2_triviaqa_train_answer_types_all30.npy", answer_types_all)