...
def main(hparams={}):
    # model_path = "ckpts/sft_triviaqa_llama7B_full_normalized/checkpoint_08000/hf_model/"
    ...
    def eval_fn(eval_dataloader, model, tokenizer, device, config, accelerator):
        ...
        if accelerator.is_main_process:
            ...
            # np.save(os.path.join(config.model.model_path, "trainpts_answer_log_probs_mean_all2_spacing2.npy"), answer_log_probs_mean_all)
            np.save(("triviaqa_trainpts_base_model_answer_log_probs_mean_all2_spacing2.npy"), answer_log_probs_mean_all)
